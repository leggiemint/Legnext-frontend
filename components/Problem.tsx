...
// For instance:
// - Hero: "PNGTuberMaker helps streamers create avatars fast"
// - Problem Agitation: "Streamers spend too much time on complex avatar creation, get frustrated, and quit." (not about PNGTuberMaker at all)
// - Features: "PNGTuberMaker has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
