  ...
  return (
    <main className="h-screen w-full bg-gray-50 font-sans antialiased flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-md w-full">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-red-600 mt-1">
                  {error === "OAuthCallback" 
                    ? "OAuth callback configuration error. Please check Google/GitHub OAuth application callback URL settings."
        ...
        <div className="bg-white backdrop-blur-sm border border-gray-200 rounded-2xl p-6 shadow-lg space-y-3">
          <button
